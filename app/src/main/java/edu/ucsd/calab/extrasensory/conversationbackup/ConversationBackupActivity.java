 ...
 * </pre>
 */
public class ConversationBackupActivity extends BaseCBActivity {
    ...
    private static final String TAG = ConversationBackupActivity.class.getSimpleName();
    ...
    protected void onCreateBaseCallback() {
        ...
        dfEula.setMyAction((dialog1, id1) -> {
            SharedPreferences sharedPreferences = Helper.getPreferences(ConversationBackupActivity.this);
        ...
        dfProcess.setMyAction((dialog1, id1) -> ConversationBackupActivity.this.process());
