...
import edu.ucsd.calab.extrasensory.conversationbackup.Helper.Cl;
import edu.ucsd.calab.extrasensory.conversationbackup.Helper.MmsEntry;
import edu.ucsd.calab.extrasensory.conversationbackup.Helper.Ms;
...
public class ProcessingService extends IntentService {
    ...
    private void updateProgress(String message, int percent) {
        ...
        Intent notificationIntent = new Intent(this, ConversationBackupActivity.class);
