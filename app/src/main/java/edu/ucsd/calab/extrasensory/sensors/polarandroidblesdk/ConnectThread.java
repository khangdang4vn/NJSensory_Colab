...
import edu.ucsd.calab.extrasensory.sensors.WatchProcessing.DataHandler;
import edu.ucsd.calab.extrasensory.sensors.WatchProcessing.PolarActivity;
...
public class ConnectThread extends Thread {
    ...
    public ConnectThread(BluetoothDevice device, PolarActivity ac) {
