 ...
 * This handler is specalised for decoding polar heart rate monitor and get the data from it
 ...
 *
 *   Now also work for BTLE based on the bluetooth protocol.
 *


//public class DataHandler extends Observable{
//    private static final DataHandler dd = new DataHandler();

    //DATA FOR SAVING
   // boolean newValue = true;
    //SimpleXYSeries series1;
   // ConnectThread reader;
   // ConnectThread Polardevice;
 ...
 //   int val=0;
   ...
   //     this.series1 = series1;
    ...
    public void setPolardevice(ConnectThread Polardevice){
        this.Polardevice = Polardevice;
    }
    public ConnectThread getPolardevice(){
        return Polardevice;
    }
}
*/