 ...
 *
@SuppressLint("NewApi")
public class PolarConnectThread extends Thread{
    PolarActivity ac;
    ...
    public PolarConnectThread(BluetoothDevice device, PolarActivity ac) {
        ...
        public void onServicesDiscovered(final BluetoothGatt gatt, final int status) {
            ...
            for (BluetoothGattCharacteristic cc : characteristics)
            {
                for (BluetoothGattDescriptor descriptor : cc.getDescriptors()) {
                    ...
                    PolarConnectThread.descriptor=descriptor;
                    PolarConnectThread.cc=cc;
